...
function Header() {
  ...
  return (
	  ...
	  <div className="w-5/6 h-full backdrop-blur-sm bg-white/10 flex justify-center rounded-xl">
	 	<div className="w-2/3 h-full flex justify-between">
			...
			<div className="h-full flex gap-4 text-gray-500">
	  			<button onClick={e => setdarkMode(!darkMode)} className="cursor-pointer hover:text-black duration-500">testing</button>
